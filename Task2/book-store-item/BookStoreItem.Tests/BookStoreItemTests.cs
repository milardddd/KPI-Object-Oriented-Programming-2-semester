...
public class BookStoreItemTests
{
    ...
    [
        ...
        [
            "ValidateIsbnFormat", new object[] { "1617294534" }, true
        ],
        [
            "ValidateIsbnFormat", new object[] { string.Empty }, false
        ],
        [
            "ValidateIsbnFormat", new object[] { "161729453" }, false
        ],
        [
            "ValidateIsbnFormat", new object[] { "16172945345" }, false
        ],
        [
    ...
    public void GetIsniUri_IsniIsNotSet_ThrowsInvalidOperationException()
    {
        ...
        // Assert
        _ = Assert.Throws<InvalidOperationException>(() => bookStoreItem.GetIsniUri());
    }
    ...
    public void HasRequiredMembers()
    {
        ...
        Assert.That(11, Is.EqualTo(this.classType!.GetFields(BindingFlags.Instance | BindingFlags.NonPublic).Length));
        ...
        Assert.That(4, Is.EqualTo(this.classType!.GetConstructors(BindingFlags.Instance | BindingFlags.Public).Length));
        ...
        Assert.That(11, Is.EqualTo(this.classType!.GetProperties(BindingFlags.Instance | BindingFlags.Public).Length));
        ...
        Assert.That(4, Is.EqualTo(this.classType!.GetMethods(BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.DeclaredOnly).Length));

        Assert.That(19, Is.EqualTo(this.classType!.GetMethods(BindingFlags.Instance | BindingFlags.Public | BindingFlags.DeclaredOnly).Length));
        Assert.That(3, Is.EqualTo(this.classType!.GetMethods(BindingFlags.Instance | BindingFlags.NonPublic | BindingFlags.DeclaredOnly).Length));
    ...
    {
        _ = this.AssertThatClassHasProperty(propertyName, propertyType, hasGet, isGetPublic, hasSet, isSetPublic);
    }
