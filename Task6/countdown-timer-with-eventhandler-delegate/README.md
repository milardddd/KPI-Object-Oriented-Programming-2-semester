...
- Provide the implementation of the [Factory method](CountdownTimer/Factories/TimerFactory.cs) (see [Factory method theory](https://en.wikipedia.org/wiki/Factory_method_pattern)) to create objects of the `Timer` and `CountDownNotifier` classes.
