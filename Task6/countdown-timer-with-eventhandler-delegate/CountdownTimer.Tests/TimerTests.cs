...
public class TimerTests
{
    ...
    {
        _ = Assert.Throws<ArgumentException>(() => this.timerFactory.CreateTimer(timerName, 1));
    }
    ...
    {
        _ = Assert.Throws<ArgumentException>(() => this.timerFactory.CreateTimer("tea", totalTicks));
    }
}
