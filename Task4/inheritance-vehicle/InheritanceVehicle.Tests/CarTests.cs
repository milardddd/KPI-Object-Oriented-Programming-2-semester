...
public class CarTests
{
    ...
    {
        Assert.That(this.carType, Is.Not.Null, "'Car' class is not created.");
    }
    ...
    public void Car_Inherits_Vehicle()
    {
        ...
        Assert.That(carInstance!, Is.Not.SameAs(vehicleType), "'Car' type does NOT inherit 'Vehicle' type.");
    }
    ...
    public void Set_Name_Method_Is_Defined()
    {
        ...
        Assert.That(method, Is.Not.Null, "Method which changes 'Car' name is NOT define or it does NOT contain correct parameters.");
    }
    ...
    public void Get_Name_Method_Is_Defined()
    {
        ...
        Assert.That(method, Is.Not.Null, "Method which retrieves 'Car' name is NOT define or it is's return type is NOT correct.");
    }
    ...
    public void Get_Car_Name()
    {
        ...
        Assert.That(carName, Is.EqualTo(newName), $"'{getNameMethod.Name}' method does NOT return correct value or '{setNameMethod.Name}' method does NOT change car name correctly.");
    }
}
